...
void UBXHandleVEL()
{
  ...
  if (UBX.state.gpsFix>1) {
    ...
    UBX.state.last_spd = UBX.Message.navVel.gSpeed;
    UBX.state.last_hdng = UBX.Message.navVel.heading;
  }
...
void UBXShow(bool json)
{
  ...
  dtostrfd((double)UBX.state.last_spd/27.778f,1,spd);
  dtostrfd((double)UBX.state.last_hdng/100000.0f,1,hdng);
